...
class Button:
    def __init__(self, surface, x, y, width, height, state=None, id=None, function=None, color=(255,255,255), hover_color=(50,50,55), border=True, border_width=2, border_color=(0,0,0), text='', font_name="arial", text_size=20, text_color=(255,255,255)):
        self.type = 'button'
        self.x = x
        self.y = y
        self.pos = vec(x,y)
